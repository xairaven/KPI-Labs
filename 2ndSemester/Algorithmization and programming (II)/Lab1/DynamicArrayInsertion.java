...
public class DynamicArrayInsertion<Item extends Comparable<Item>> implements Iterable<Item> {
     ...
     */
    public static void Sort(DynamicArrayInsertion arr) {
    ...
    public static void main(String[] args) {
        DynamicArrayInsertion<Integer> arr = new DynamicArrayInsertion<>();
